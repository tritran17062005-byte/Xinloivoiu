...
import { Heart, Cookie, Sparkles, PartyPopper, Music, Flower2, Calendar, Laugh, ThumbsUp, HandHeart } from "lucide-react";
...
/**
 * 🧸 HƯỚNG DẪN NHANH
 * - Đổi tên người yêu ở biến defaultPartnerName.
 * - Thay đổi tông màu bằng cách chỉnh các lớp tailwind (bg-pink-50, text-pink-600, ...).
 * - Sửa danh sách lý do & cam kết ở mảng reasons và promises.
 * - Nhấn “Xuất hiện trái tim” để tạo hiệu ứng mưa tim.
 */

const defaultPartnerName = "Em"; // ví dụ: "My", "Hà", "Anh"...
...
const promises = [
  ...
  "Đặt lịch hẹn bù vào cuối tuần này.",
];
...
export default function ApologyPage() {
  ...
  return (
    <div className="min-h-screen bg-pink-50 text-pink-900 flex items-center justify-center p-4">
              ...
              <div>
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  ...
                  <Button
                    ...
                    variant="outline"
                  >
                    <Laugh className="w-4 h-4 mr-2" /> Cho một cái cười đi
                  </Button>
                </div>
              </div>
